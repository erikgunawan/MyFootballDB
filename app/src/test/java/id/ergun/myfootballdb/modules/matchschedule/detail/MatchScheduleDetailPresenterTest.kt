...
class MatchScheduleDetailPresenterTest {
    ...
    fun setUp() {
        ...
        presenter = MatchScheduleDetailPresenter(view, repository, ScheduleProviderTest(), compositeDisposable)
    }
    ...
    fun getDetailEventTest() {
        ...
        whenever(repository.getDetailEvent(id))
    ...
    fun getDetailTeamTest() {
        ...
        whenever(repository.getDetailTeam(id))
